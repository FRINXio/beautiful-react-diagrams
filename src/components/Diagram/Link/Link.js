...
const Link = (props) => {
  ...
  const inputPoint = useMemo(() => getCoords(input, portRefs, nodeRefs), [input, portRefs, nodeRefs]);
  ...
  const outputPoint = useMemo(() => getCoords(output, portRefs, nodeRefs), [output, portRefs, nodeRefs]);
